                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code>Extra 750/- Per Month</code></label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="customRadio2" value="0" name="foodstatus"
                                        class="custom-control-input" checked>
                                    <label class="custom-control-label" for="customRadio2">Not Required<code>Regular Rs.750 Per Month</code></label>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Total Amount</h4>
                                    <div class="form-group">
                                        <input type="" name="ta"  id="ta" placeholder="Total Amount here.." required class="form-control">
                                    </div>
                            </div>
                        </div>
                    </div>
